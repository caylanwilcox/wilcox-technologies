...
import problemImage from './Images/problem.jpg'; // Update the path to your image
import visibilityImage from './Images/visibility.jpeg'; // Update the path to your image
